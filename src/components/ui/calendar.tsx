    ...
    <DayPicker
      ...
      classNames={{
        ...
        button_previous: cn(
          ...
          "absolute left-1 top-3 z-10 h-7 w-7 bg-transparent p-0 opacity-50 hover:opacity-100",
        ),
        button_next: cn(
          buttonVariants({ variant: "outline" }),
          "absolute right-1 top-3 z-10 h-7 w-7 bg-transparent p-0 opacity-50 hover:opacity-100",
        ),
