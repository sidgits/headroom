...
const ShareButtons = ({ archetypeName }: ShareButtonsProps) => {
  ...
  const handleShare = (platform: string) => {
    ...
    setTimeout(() => {
      toast.success("Thank you for sharing! 🙌", { duration: 3000 });
  ...
  return (
    <div className="flex items-center gap-3 flex-wrap">
      {socials.map(({ icon: Icon, label }) => (
        ...
        >
          <div className="w-10 h-10 rounded-xl bg-secondary/80 border border-border/50 flex items-center justify-center text-muted-foreground group-hover:text-foreground group-hover:border-primary/40 group-hover:bg-primary/10 transition-all">
            <Icon />
          </div>
