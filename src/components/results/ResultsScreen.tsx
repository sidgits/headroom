          ...
          <div className="space-y-3 pt-2">
            ...
            <div className="flex flex-col sm:flex-row gap-3">
              <button
                ...
                className="flex-1 flex items-center justify-center gap-3 py-3 rounded-2xl bg-card border border-border/60 hover:border-primary/40 hover:bg-primary/5 transition-all text-sm font-medium text-foreground"
              >
              ...
              <button
                disabled
                title="Coming soon"
                className="flex-1 flex items-center justify-center gap-3 py-3 rounded-2xl bg-card border border-border/60 text-sm font-medium text-muted-foreground opacity-60 cursor-not-allowed"
              >
                <svg className="w-5 h-5" viewBox="0 0 24 24">
