...
export const ARCHETYPE_META: Record<string, ArchetypeProfileMeta> = {
  architect: {
    ...
    defaultBurnout: {
      ...
      description: "Your growth orientation protects you from acute burnout — for now. But sustained fragmentation of deep work creates slow accumulation of toxic load that eventually overrides your growth capacity. Burnout arrives quietly, as disengagement disguised as busyness.",
  ...
  firefighter: {
    ...
    defaultBurnout: {
      ...
      signal: "Chronic urgency mode without growth recovery.",
      description: "This is the highest burnout risk profile in the Headroom system. High toxic load with near-zero growth load is the precise signature of chronic occupational stress. You're consuming capability, not building it. Without intervention the trajectory leads to exhaustion and sudden collapse of the high-performance identity you've built.",
  ...
  conductor: {
    ...
    workingAgainstYou: "Your contribution is almost entirely invisible. In environments that measure output over orchestration, your value is chronically underrecognized.",
    patternNotNoticed: "You've become so good at managing everyone else's cognitive load that you've stopped prioritizing your own. When did you last do work that was purely yours?",
    ...
    defaultBurnout: {
      level: "moderate",
      label: "Moderate — Latent Risk",
      signal: "High coordination load with under-recognized contribution.",
  ...
  ghost: {
    ...
    defaultBurnout: {
      ...
      signal: "Growth load near zero — work no longer provides meaning signal.",
      description: "The most dangerous profile precisely because it is invisible. No performance flags, no complaints, no obvious distress. But near-zero growth load means the work has stopped providing core reward. This is the pattern behind unexpected resignations that surprise managers.",
